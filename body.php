...
<div id="body">    
    ...
    <div id="dcmenu" style="display:none">
        <div id="allowDefaultContextMenuForNsec" style="padding:1px;border:1px solid #DDF;border-collapse: collapse" class="cmenuItem" onmousedown="cmenu.onblur=cmenu.onblurFunc;core.defaultCMenu.call(this);cmenu.onblurFunc.call(cmenu);">AllowDefaultContextMenuFor<input id="time" style="width:15px" value="10" onmousedown="cmenu.onblur=null;event.cancelBubble=true;" onclick="event.cancelBubble=true;" onkeydown="event.cancelBubble=true;if(event.keyCode==13){this.parentElement.onmousedown.call(this.parentElement)};" onblur="cmenu.onblur=cmenu.onblurFunc;cmenu.onblur.call(cmenu)"/>sec</div>
    </div>
</div>